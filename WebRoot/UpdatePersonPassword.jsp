        ...
        <div class="block">
            ...
            <div class="block-body">
                <form action="updUser.action" method="post">
                    ...
                    <input id="pwdNew" type="password" class="span12" name="pwdNew" required="required">
                    <label>确认密码</label>
                    <i class="fa fa-check" ></i>
                    <input id="repwdNew" type="password" class="span12" onchange="check()">
                    <p id="tip"><font size="3" color="red">${tip}</p>
...
<script>
	function check(){
		...
		if(pwdNew != repwdNew){
				...
				//document.getElementById("tips").value="请确认两次密码输入是否一致！";
				window.alert("请确认两次密码输入是否一致！");
				return;
		}
		else
